...
extern "C"
{
  ...
  int32 fckit__SIGABRT() { return SIGABRT; }
  int32 fckit__SIGKILL() { return SIGKILL; }
  int32 fckit__SIGINT()  { return SIGINT;  }
  int32 fckit__SIGALRM() { return SIGALRM; }
  int32 fckit__SIGFPE()  { return SIGFPE;  }
  int32 fckit__SIGTERM() { return SIGTERM; }
  int32 fckit__SIGSEGV() { return SIGSEGV; }
  int32 fckit__SIGILL()  { return SIGILL;  }
